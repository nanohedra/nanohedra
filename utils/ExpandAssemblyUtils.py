...
def get_ptgrp_sym_op(sym_type, expand_matrix_dir=os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/symmetry_operators/POINT_GROUP_SYMM_OPERATORS"):
...
def get_sg_sym_op(sym_type, space_group_operator_dir=os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/symmetry_operators/SPACE_GROUP_SYMM_OPERATORS"):
